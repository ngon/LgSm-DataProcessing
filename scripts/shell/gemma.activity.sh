...
echo "Running command:" `tail -n +$PBS_ARRAYID /group/palmer-lab/AIL/code/gemma.activity.emp.cmds | head -1`
tail -n +$PBS_ARRAYID /group/palmer-lab/AIL/code/gemma.activity.emp.cmds | head -1 | sh
