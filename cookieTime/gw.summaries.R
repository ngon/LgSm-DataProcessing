...
pdf(file="/group/palmer-lab/AIL/LgSm-DataProcessing/figures/gw_maf.pdf",
    height=4, width=4, colormodel="cmyk")

ggplot(data=all_maf, aes(x=Var1, y=Freq/sum(Freq))) +
    geom_bar(stat="identity", fill="grey77", color="black") +
...
pdf(file="/group/palmer-lab/AIL/LgSm-DataProcessing/figures/gw_het.pdf",
    height=4, width=4, colormodel="cmyk")
